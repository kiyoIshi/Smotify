...
class Constants {
  ...
  public static $passwordCharacters = "Your password must be between 2 and 25 characters";
  public static $emailInvalid = "Email is invalid";
  public static $emailsDoNotMatch = "Your emails don't match";
  public static $emailTaken = "This email already in use";
  public static $lastNameCharacters = "Your lastname must be between 2 and 25 characters";
  public static $fristnameCharacters = "Your firstname must be between 2 and 25 characters";
